...
@Mapper(componentModel = "spring", uses = com.tecdesoftware.market.persistance.mapper.CategoryMapper.class)
public interface ProductMapper {
    ...
    @Mappings({
            ...
            @Mapping(target = "idCategoria", source = "category.categoryId")
    })
